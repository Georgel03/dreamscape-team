...
import { Sparkles, Mic, ArrowUp, SlidersHorizontal, X, Users, Sun, Eye, Music, Lock, Globe } from 'lucide-react';
...
export default function ChatInput() {
  ...
  const handleSubmission = async () => {
    ...
    if (visibility) enrichedPrompt += `VISIBILITY: ${visibility}.\n`;
      ...
      {isExpanded && (
        <div className="absolute bottom-full left-4 right-4 mb-3 bg-[#0f0f12]/95 backdrop-blur-xl border border-[#C393F5]/20 rounded-2xl p-5 shadow-2xl animate-in slide-in-from-bottom-2 fade-in duration-300 z-30 max-h-[70vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="space-y-6">
                ...
                {/* SECTION 0: VISIBILITY */}
                <div className="bg-white/5 rounded-xl p-4 border border-white/5">
                   <label className="text-[10px] text-slate-400 uppercase tracking-wider font-medium mb-3 block">Visibility Settings</label>
                   ...
                   <p className="text-[10px] text-slate-500 mt-2 text-center">
                     {visibility === 'PRIVATE' 
                       ...
                       : "This dream will be visible to the community."}
                   </p>
                </div>
