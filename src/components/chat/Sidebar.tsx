import { Sparkles, PanelLeftClose, Plus, MessageSquare, Archive, Library, Crown, MoreHorizontal, X } from 'lucide-react';
        ...
        <div className={`flex flex-col flex-1 min-w-[240px] whitespace-nowrap ${(!isOpen && 'md:invisible')} transition-all duration-200`}>
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <nav className="space-y-1">
                <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/5 text-white">
                  <MessageSquare className="w-4.5 h-4.5 text-[#C393F5]" />
                  <span className="text-sm">Chat</span>
                </a>
                <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:bg-white/5 hover:text-white transition-colors">
